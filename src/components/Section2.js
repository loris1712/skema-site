          ...
          <div className="flex space-x-4">
            <div>
              <div className="flex items-center space-x-4">
                ...
                <h3 className="font-semibold text-[24px] text-black">Trasforma la tua sbobina in skema!</h3>

              </div>
              <p className="text-gray-600 mt-4">
                Carichi il testo, ottieni uno schema logico pronto da studiare.

                -70% tempo. +100% chiarezza.
                Taglia il superfluo, collega i concetti, ti dà la base per il tuo skema digitale!

                Personalizza tutto. Studia meglio.
              </p>            
              </div>
          </div>
        </div>
